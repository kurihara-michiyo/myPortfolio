...
if (isset($_REQUEST['btn'])) {
  ...
  switch ($lot) {
    case 0:
      ...
      <img src="img/card-ring-.jpg" alt="カード柄側" class="card2">
      </div>';
      $tos =
      '
        <h3 class="card_spirit">意味：幸運、運命的、大きな変化</h3>
        <div class="text">
          今いい流れが来ている予感あり<br>
          物事がうまくいく可能性大
         </div>
    ...
    case 1:
      ...
      <img src="img/tarots.jpg" alt="カード表紙" class="card1">
      <img src="img/card-magic-.jpg" alt="カード柄側" class="card2">
      </div>';
      $tos =
      '
        <h3 class="card_spirit">意味：創造、自信</h3>
        <div class="text">
    ...
    case 2:
      ...
      <img src="img/tarots.jpg" alt="カード表紙" class="card1">
      <img src="img/card-hand-.jpg" alt="カード柄側" class="card2">
      </div>
      ';
      $tos =
      '
        <h3 class="card_spirit">意味：強固、意志、困難</h3>
        <div class="text">
    ...
    case 3:
      ...
      <img src="img/tarots.jpg" alt="カード表紙" class="card1">
      <img src="img/card-cake-.jpg" alt="カード柄側" class="card2">
      </div>
      ';
      $tos =
      '
        <h3 class="card_spirit">意味：災難、崩壊、トラブル、不安</h3>
        <div class="text">
    ...
    case 4:
      ...
      <img src="img/tarots.jpg" alt="カード表紙" class="card1">
      <img src="img/card-piero-.jpg" alt="カード柄側" class="card2">
      </div>
      ';
      $tos =
      '
        <h3 class="card_spirit">意味：自由、未確定、無計画</h3>
        <div class="text">
    ...
    case 5:
      ...
      <img src="img/tarots.jpg" alt="カード表紙" class="card1">
      <img src="img/card-book-.jpg" alt="カード柄側" class="card2">
      </div>
      ';
      $tos =
      '
        <h3 class="card_spirit">意味：模索、静寂、閉鎖的、孤立</h3>
        <div class="text">
